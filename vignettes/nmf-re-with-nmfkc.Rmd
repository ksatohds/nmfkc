...
```{r dfU-scan}
scan_result <- nmfre.dfU.scan(1:10/10, Y, A, Q = 1, epsilon = 1e-08)
scan_result
```
...
```{r fit-nmfre}
res <- nmfre(Y, A, Q = 1, dfU.cap.rate = 0.2, epsilon = 1e-08, prefix = "Trend")
```
...
res_fixed <- nmfkc(Y, A = A, Q = 1, epsilon = 1e-08)
