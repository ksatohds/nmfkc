...
dot_args <- list(Y.label = as.character(1:N), X.label = paste("Community", 1:K),
...
dot_soft <- do.call(nmfkc.net.DOT, c(list(res), dot_args, Y.cluster = "soft"))
...
dot_hard <- do.call(nmfkc.net.DOT, c(list(res), dot_args, Y.cluster = "hard"))
